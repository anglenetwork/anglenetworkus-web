...
async function main() {
  ...
  if (!readiness.ready) {
    ...
    console.error('1. Apply supabase-migrations/20260327_article_metrics.sql to your Supabase project.');
  ...
  console.log('\n--- ok ---');
  console.log('If counts are zero, run backfill and/or open articles in the browser.');
  process.exit(0);
}
