...
// Query: *[_type == "post" && category->slug.current == $categorySlug && defined(slug.current) && defined(tickerTitle)] | order(date desc, _updatedAt desc) [0...5] {    tickerTitle,    "slug": slug.current  }
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n  *[_type == \"post\" && category->slug.current == $categorySlug && defined(slug.current) && defined(tickerTitle)] | order(date desc, _updatedAt desc) [0...5] {\n    tickerTitle,\n    \"slug\": slug.current\n  }\n": CategoryTickerQueryResult;
