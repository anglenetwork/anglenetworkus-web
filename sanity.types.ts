...
// Source: sanity/lib/article-family-queries.ts
// Variable: articleFamilyBookmarksBySlugsQuery
// Query: *[_type in ["post", "opinion", "analysis", "sponsored"] && slug.current in $slugs] {      _id,  _type,  "title": coalesce(title, "Untitled"),  "slug": slug.current,  "date": coalesce(publishedAt, _updatedAt),  cover{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  }  }
export type ArticleFamilyBookmarksBySlugsQueryResult = Array<
  | {
      _id: string;
      _type: "analysis";
      title: string | "Untitled";
...
// Source: sanity/lib/article-family-queries.ts
// Variable: sponsoredIndexQuery
// Query: *[    _type == "sponsored" &&      status == "published" &&  defined(publishedAt) && publishedAt <= now() &&    defined(slug.current)  ] | order(coalesce(publishedAt, _updatedAt) desc, _updatedAt desc) [$start...$end] {      _id,  _type,  "status": select(_originalId in path("drafts.**") => "draft", "published"),  "title": coalesce(title, "Untitled"),  "tickerTitle": coalesce(tickerTitle, ""),  "slug": slug.current,  excerpt,  readTime,    cover{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },  publishedAt,  updatedAt,    "author": select(    defined(author->name) => {      "name": coalesce(author->name, "Anonymous"),      "slug": author->slug.current,      "picture": author->picture    }  ),    "category": select(    defined(category->name) && defined(category->slug.current) => {      "title": category->name,      "slug": category->slug.current    }  ),  "tags": tags[]->{    "title": coalesce(title, name),    "slug": slug.current  },    disclosure,  analysisFocus,  methodologyNote,  sourcesNote,  sponsorAttribution{    sponsorName,    sponsorUrl,    disclosure  }  }
export type SponsoredIndexQueryResult = Array<{
  _id: string;
  _type: "sponsored";
  status: "draft" | "published";
  title: string | "Untitled";
...
// Source: sanity/lib/article-family-queries.ts
// Variable: sponsoredIndexCountQuery
// Query: count(*[    _type == "sponsored" &&      status == "published" &&  defined(publishedAt) && publishedAt <= now() &&    defined(slug.current)  ])
export type SponsoredIndexCountQueryResult = number;
...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now()  ] | order(      select(mainHeadline == true => 1, 0) desc,    dateTime(publishedAt) desc,  dateTime(_updatedAt) desc  )[0...1] {      _id,  _type,  "status": select(_originalId in path("drafts.**") => "draft", "published"),  "title": coalesce(title, "Untitled"),  "slug": slug.current,  excerpt,  readTime,  cover{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },  "date": coalesce(publishedAt, _updatedAt),  publishedAt,  updatedAt,  priority,  featured,  labels,  justIn,  breakingNews,  developingStory,  mainHeadline,  frontline,  rightHeadline,  "author": select(    defined(author->name) => {      "name": coalesce(author->name, "Anonymous"),      "picture": author->picture    }  ),  "category": select(    defined(category->name) && defined(category->slug.current) => {      "title": category->name,      "slug": category->slug.current    }  ),  // Support both tag.title and category.name during transition  "tags": tags[]->{    "title": coalesce(title, name),    "slug": slug.current  },    "imageGallery": imageGallery[]{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  }  }
...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now()  ] | order(      select(frontline == true => 1, 0) desc,    dateTime(publishedAt) desc,  dateTime(_updatedAt) desc  )[0...2] {      _id,  _type,  "status": select(_originalId in path("drafts.**") => "draft", "published"),  "title": coalesce(title, "Untitled"),  "slug": slug.current,  excerpt,  readTime,  cover{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },  "date": coalesce(publishedAt, _updatedAt),  publishedAt,  updatedAt,  priority,  featured,  labels,  justIn,  breakingNews,  developingStory,  mainHeadline,  frontline,  rightHeadline,  "author": select(    defined(author->name) => {      "name": coalesce(author->name, "Anonymous"),      "picture": author->picture    }  ),  "category": select(    defined(category->name) && defined(category->slug.current) => {      "title": category->name,      "slug": category->slug.current    }  ),  // Support both tag.title and category.name during transition  "tags": tags[]->{    "title": coalesce(title, name),    "slug": slug.current  },    "imageGallery": imageGallery[]{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  }  }
...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now()  ] | order(      select(rightHeadline == true => 1, 0) desc,    dateTime(publishedAt) desc,  dateTime(_updatedAt) desc  )[0...10] {      _id,  "title": coalesce(title, "Untitled"),  "slug": slug.current,  readTime,  cover{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  }  }
...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now() &&    category->slug.current == $categorySlug &&    _id != $excludePostId  ] | order(      dateTime(publishedAt) desc,  dateTime(_updatedAt) desc  )[0...3] {      _id,  _type,  "status": select(_originalId in path("drafts.**") => "draft", "published"),  "title": coalesce(title, "Untitled"),  "slug": slug.current,  excerpt,  readTime,  cover{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },  "date": coalesce(publishedAt, _updatedAt),  publishedAt,  updatedAt,  priority,  featured,  labels,  justIn,  breakingNews,  developingStory,  mainHeadline,  frontline,  rightHeadline,  "author": select(    defined(author->name) => {      "name": coalesce(author->name, "Anonymous"),      "picture": author->picture    }  ),  "category": select(    defined(category->name) && defined(category->slug.current) => {      "title": category->name,      "slug": category->slug.current    }  ),  // Support both tag.title and category.name during transition  "tags": tags[]->{    "title": coalesce(title, name),    "slug": slug.current  },    "imageGallery": imageGallery[]{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  }  }
...
// Source: sanity/lib/queries.ts
// Variable: navTagsWithCategoryQuery
// Query: *[    _type == "tag" &&    defined(slug.current) &&    defined(category->slug.current) &&    hidden != true &&    deprecated != true  ] | order(coalesce(order, 999) asc, title asc) {    "slug": slug.current,    title,    "categorySlug": category->slug.current  }
export type NavTagsWithCategoryQueryResult = Array<{
  slug: string | null;
  title: string | null;
...
// Source: sanity/lib/queries.ts
// Variable: tagsByCategorySlugQuery
// Query: *[    _type == "tag" &&    category->slug.current == $categorySlug &&    defined(slug.current) &&    hidden != true &&    deprecated != true  ] | order(coalesce(order, 999) asc, title asc) [0...$tagLimit] {    "slug": slug.current,    title  }
export type TagsByCategorySlugQueryResult = Array<{
  slug: string | null;
  title: string | null;
}>;

// Source: sanity/lib/queries.ts
// Variable: latestArticleByTagGlimpseQuery
// Query: *[    _type in ["post", "analysis"] &&    status == "published" &&    defined(slug.current) &&    defined(publishedAt) &&    publishedAt <= now() &&    $tagSlug in tags[]->slug.current &&    !(_id in $excludeIds)  ] | order(  dateTime(publishedAt) desc,  dateTime(_updatedAt) desc) [0...1] {    _type,      _id,  "title": coalesce(title, "Untitled"),  "slug": slug.current,  readTime,  cover{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },    "imageGallery": imageGallery[]{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },  "category": select(    defined(category->name) && defined(category->slug.current) => {      "title": category->name,      "slug": category->slug.current    }  )  }
export type LatestArticleByTagGlimpseQueryResult = Array<
  | {
      _type: "analysis";
      _id: string;
      title: string | "Untitled";
...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now() &&    category->slug.current == $categorySlug  ] | order(  dateTime(publishedAt) desc,  dateTime(_updatedAt) desc) [2...3] {      _id,  _type,  "status": select(_originalId in path("drafts.**") => "draft", "published"),  "title": coalesce(title, "Untitled"),  "slug": slug.current,  excerpt,  readTime,  // New cover (external or asset)  cover{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },  "date": coalesce(publishedAt, _updatedAt),  publishedAt,  updatedAt,  priority,  featured,  labels,  justIn,  breakingNews,  developingStory,  mainHeadline,  frontline,  rightHeadline,  "author": select(    defined(author->name) => {      "name": coalesce(author->name, "Anonymous"),      "picture": author->picture    }  ),  "category": select(    defined(category->name) && defined(category->slug.current) => {      "title": category->name,      "slug": category->slug.current    }  ),  // Support both tag.title and category.name during transition  "tags": tags[]->{    "title": coalesce(title, name),    "slug": slug.current  },  "body": body[]{    ...,    _type == "editorialImage" => {        source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights,      layout    },    _type == "tweetEmbed" => {      _type,      _key,      url,      caption    }  },    "imageGallery": imageGallery[]{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },  seo{    title,    description,    canonicalUrl,    ogImage{      asset,      hotspot,      crop,      alt    }  }  }
...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now() &&    category->slug.current == $categorySlug  ] | order(  dateTime(publishedAt) desc,  dateTime(_updatedAt) desc) [0...1] {      _id,  "title": coalesce(title, "Untitled"),  "slug": slug.current,  readTime,  cover{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },    "imageGallery": imageGallery[]{      source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights  },  "category": select(    defined(category->name) && defined(category->slug.current) => {      "title": category->name,      "slug": category->slug.current    }  )  }
...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now() &&    defined(tickerTitle)  ] | order(  dateTime(publishedAt) desc,  dateTime(_updatedAt) desc) [0...4] {    tickerTitle,    "slug": slug.current  }
...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now() &&    category->slug.current == $categorySlug &&    defined(tickerTitle)  ] | order(  dateTime(publishedAt) desc,  dateTime(_updatedAt) desc) [0...4] {    tickerTitle,    "slug": slug.current  }
...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now()  ] | order(      select(mainHeadline == true => 1, 0) desc,    dateTime(publishedAt) desc,  dateTime(_updatedAt) desc  ) [0...5] {    _id,    title,    "slug": slug.current,    cover{        source,  externalUrl,  image,  "lqip": image.asset->metadata.lqip,  "dimensions": image.asset->metadata.dimensions { width, height },  alt,  "caption": coalesce(caption, epigraph),  creditAuthor,  "creditSource": coalesce(creditSource, creditProvider),  licenseOrRights    }  }
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '\n  *[_type in ["post", "opinion", "analysis", "sponsored"] && slug.current in $slugs] {\n    \n  _id,\n  _type,\n  "title": coalesce(title, "Untitled"),\n  "slug": slug.current,\n  "date": coalesce(publishedAt, _updatedAt),\n  cover{\n    \n  source,\n  externalUrl,\n  image,\n  "lqip": image.asset->metadata.lqip,\n  "dimensions": image.asset->metadata.dimensions { width, height },\n  alt,\n  "caption": coalesce(caption, epigraph),\n  creditAuthor,\n  "creditSource": coalesce(creditSource, creditProvider),\n  licenseOrRights\n\n  }\n\n  }\n': ArticleFamilyBookmarksBySlugsQueryResult;
    ...
    '\n  *[\n    _type == "sponsored" &&\n    \n  status == "published" &&\n  defined(publishedAt) && publishedAt <= now()\n &&\n    defined(slug.current)\n  ] | order(coalesce(publishedAt, _updatedAt) desc, _updatedAt desc) [$start...$end] {\n    \n  _id,\n  _type,\n  "status": select(_originalId in path("drafts.**") => "draft", "published"),\n  "title": coalesce(title, "Untitled"),\n  "tickerTitle": coalesce(tickerTitle, ""),\n  "slug": slug.current,\n  excerpt,\n  readTime,\n  \n  cover{\n    \n  source,\n  externalUrl,\n  image,\n  "lqip": image.asset->metadata.lqip,\n  "dimensions": image.asset->metadata.dimensions { width, height },\n  alt,\n  "caption": coalesce(caption, epigraph),\n  creditAuthor,\n  "creditSource": coalesce(creditSource, creditProvider),\n  licenseOrRights\n\n  }\n,\n  publishedAt,\n  updatedAt,\n  \n  "author": select(\n    defined(author->name) => {\n      "name": coalesce(author->name, "Anonymous"),\n      "slug": author->slug.current,\n      "picture": author->picture\n    }\n  )\n,\n  \n  "category": select(\n    defined(category->name) && defined(category->slug.current) => {\n      "title": category->name,\n      "slug": category->slug.current\n    }\n  ),\n  "tags": tags[]->{\n    "title": coalesce(title, name),\n    "slug": slug.current\n  }\n,\n  \n  disclosure,\n  analysisFocus,\n  methodologyNote,\n  sourcesNote,\n  sponsorAttribution{\n    sponsorName,\n    sponsorUrl,\n    disclosure\n  }\n\n\n  }\n': SponsoredIndexQueryResult;
    '\n  count(*[\n    _type == "sponsored" &&\n    \n  status == "published" &&\n  defined(publishedAt) && publishedAt <= now()\n &&\n    defined(slug.current)\n  ])\n': SponsoredIndexCountQueryResult;
