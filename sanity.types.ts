...
// Query: *[      _type == "post" &&  status == "published" &&  defined(slug.current) &&  defined(publishedAt) &&  publishedAt <= now() &&    defined(tickerTitle)  ] | order(  dateTime(publishedAt) desc,  dateTime(_updatedAt) desc) [0...5] {    tickerTitle,    "slug": slug.current  }
