  ...
  const newsSectionData = {
    ...
    mainStory: posts[0]
      ? {
          ...
          imageSource: formatImageCredit(posts[0].cover) || undefined,
    ...
    <div className="min-h-screen">
      ...
      <div className="py-8">
        <div className="grid grid-cols-12 gap-0">
          ...
          <div className="order-2 col-span-12 md:order-1 md:col-span-3">
            <LeftColumnFourth />
          </div>
          ...
          <div className="order-3 col-span-12 md:order-3 md:col-span-3">
