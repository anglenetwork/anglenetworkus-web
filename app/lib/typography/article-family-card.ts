...
/** ArticleFamilyCard — compact / large layout title */
export const articleFamilyCardTitle = `mb-2 font-sans text-base font-semibold leading-snug tracking-normal text-neutral-900 md:text-lg ${articleTitleLink}`;
