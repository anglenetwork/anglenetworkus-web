...
export const modernSectionTitle = {
  light:
    "font-bold font-display text-3xl text-news-text leading-tight tracking-tight md:text-4xl xl:text-2xl",
...
export const modernSectionTitleLarge = {
  light:
    "font-bold font-display text-4xl text-news-text leading-tight tracking-tight md:text-5xl",
...
export const minimalSectionTitle = {
  light:
    "font-bold font-sans text-base uppercase tracking-normal text-news-text",
  news: "font-bold font-sans text-base uppercase tracking-normal text-news-text",
