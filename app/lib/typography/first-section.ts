...
export const firstSectionFeaturedStoryTitle = `font-medium font-sans text-xl text-news-text leading-snug tracking-tight ${homepageArticleTitleLink}`;

/** FirstSection — More Top Headlines grid (md+, 2-up) */
export const moreTopHeadlinesGridTitle = `font-medium font-sans text-lg text-news-text leading-snug tracking-tight ${homepageArticleTitleLink}`;

/** FirstSection — left rail: remaining Just In stories */
export const justInSecondaryTitle = `text-base font-sans font-semibold text-news-text leading-snug tracking-tight ${homepageArticleTitleLink}`;
...
export const mainHeadlineMobileTitle = `text-2xl md:text-3xl lg:hidden font-bold text-news-text !leading-tight tracking-tight mb-4 font-sans text-start md:text-center ${homepageArticleTitleLink}`;
...
export const sideStoryTitle = `text-xl font-sans font-semibold text-news-text leading-snug tracking-tight ${homepageArticleTitleLink}`;
