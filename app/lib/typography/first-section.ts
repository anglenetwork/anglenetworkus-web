...
export const justInPrimaryTitle =
...
export const justInSecondaryTitle =
...
export const mainHeadlineDesktopTitle =
  "text-6xl font-bold text-gray-900 !leading-tight tracking-tight text-center font-sans";

/** FirstSection — center: mobile/tablet main headline (below lg) */
export const mainHeadlineMobileTitle =
  "text-2xl md:text-3xl lg:hidden font-bold text-gray-900 !leading-tight tracking-tight mb-4 font-sans text-start md:text-center";
...
export const moreTopHeadlinesMobileTitle =
  "min-w-0 flex-1 font-sans text-base font-semibold leading-snug tracking-tight text-neutral-900 group-hover:text-red-600";

/** FirstSection — center: More Top Headlines, md+ grid and third story */
export const moreTopHeadlinesGridTitle =
  "font-sans text-xl font-semibold leading-snug tracking-tight text-neutral-900";

/** FirstSection — right rail: side story titles */
export const sideStoryTitle =
  "text-xl font-sans font-semibold text-neutral-900 leading-snug tracking-tight";
...
export const mostReadItemTitle =
  "text-neutral-900 leading-tight font-sans text-lg sm:text-base font-normal tracking-normal";
