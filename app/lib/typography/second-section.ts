...
export const categoryFeaturedTitle = {
  ...
  news: `font-medium font-sans text-xl text-news-text leading-snug tracking-normal  ${homepageArticleTitleLink}`,
...
export const categorySecondaryRowTitle = {
  ...
  news: `font-regular font-sans text-base text-news-text leading-snug tracking-normal  ${homepageArticleTitleLink}`,
